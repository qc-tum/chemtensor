...
int main()
{
	...
	struct test tests[] = {
		...
		TEST_FUNCTION_ENTRY(test_su2_tensor_slice_scale),
		...
		TEST_FUNCTION_ENTRY(test_su2_dense_tensor_dot),
		TEST_FUNCTION_ENTRY(test_su2_tensor_qr),
		TEST_FUNCTION_ENTRY(test_su2_tensor_rq),
		TEST_FUNCTION_ENTRY(test_su2_tensor_svd),
		...
		TEST_FUNCTION_ENTRY(test_su2_mps_orthonormalize_qr),
		TEST_FUNCTION_ENTRY(test_su2_mps_split_tensor_svd),
		TEST_FUNCTION_ENTRY(test_su2_mps_to_statevector),
		...
		TEST_FUNCTION_ENTRY(test_fermi_hubbard_1d_su2_mpo),
		...
		TEST_FUNCTION_ENTRY(test_su2_dmrg_twosite),
